...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Suryaprakash@312',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 By <a href="https://github.com/SuryaprakashGaud/" style="text-decoration: none; color: #021659;">Suryaprakash</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            ...
            <b>Admin -</b> <br/>
            For login use <b>Suryaprakash</b> as username and <b>Surya@312</b> as password.<br/>
            It will load all the required stuffs and perform analysis.
        </p><br/><br/>

        <p align="justify">
            Built with 🤍 by 
            <a href="https://github.com/SuryaprakashGaud" style="text-decoration: none; color: grey;">Suryaprakash Gaud</a> through 
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'Suryaprakash' and ad_password == 'Surya@312':
                ...
                st.success("Welcome Suryaprakash ! Total %d " % values + " User's Have Used Our Tool : )")                
